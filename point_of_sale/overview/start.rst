=======================================
Getting started with ArabiaClouds Point of Sale
=======================================

Overview
========

ArabiaClouds's online Point of Sale application is based on a simple, user
friendly interface. The Point of Sale application can be used online or
offline on iPads, Android tablets or laptops.

ArabiaClouds Point of Sale is fully integrated with the Inventory and Accounting
...
.. tip::
   If you are using ArabiaClouds Accounting, do not forget to install a chart of
