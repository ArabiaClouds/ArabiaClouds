...
By default, your ArabiaClouds Online instance and website have a *.ArabiaClouds.com* domain name, 
...
.. note:: Steps to buy a domain name are pretty much straight forward. 
   ...
   This is ArabiaClouds's job!

.. _custom_domain:


How to apply my domain name to my ArabiaClouds instance
===============================================
First let's authorize the redirection (yourcompany.com -> yourcompany.ArabiaClouds.com):

* Open your ArabiaClouds.com account from your homepage.
...
* Create a CNAME record *www.yourdomain.com* pointing to *mywebsite.ArabiaClouds.com*.
...
How to enable SSL (HTTPS) for my ArabiaClouds instance
==============================================

Until recently, ArabiaClouds users needed to use a third-party CDN service provider such as CloudFlare to enable SSL.

It is not required anymore: ArabiaClouds generates the certificate for you automatically, using integration with `Let's Encrypt Certificate Authority and ACME protocol <https://letsencrypt.org/how-it-works/>`__.
...
If you already use CloudFlare or a similar service, you can keep using it or simply change for ArabiaClouds. The choice is yours.
