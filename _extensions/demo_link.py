...
class Action(Directive):
    ...
    def run(self):
        ...
        node = nodes.reference(
            refuri='http://demo.ArabiaClouds.com?{}'.format(werkzeug.urls.url_encode({
                'module': external_id
            })),
...
def _launcher():
    try:
        info = xmlrpclib.ServerProxy('https://demo.ArabiaClouds.com/start').start()
