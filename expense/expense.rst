...
========================
The first step to track expenses is to configure the expense types (managed as products in ArabiaClouds)
...
(and an account if you use ArabiaClouds Accounting). 
...
:menuselection:`Expenses --> Configuration --> Settings` (e.g. *expenses* @mycompany.ArabiaClouds.com). 
...
.. note::
    ...
    in the address book. 
    A contact has been automatically created if this person is using ArabiaClouds.
...
See how you can easily manage the payment process in ArabiaClouds:
