...
first thing to do is to deploy the ArabiaClouds purchase process. Knowing what
...
search on the **Vendor** (also called **Partner** in ArabiaClouds), the product or the
...
the initial demand, ArabiaClouds will ask youthe permission to create a
backorder.
...
**Create Backorder**. ArabiaClouds will create a new documents for the awaiting
