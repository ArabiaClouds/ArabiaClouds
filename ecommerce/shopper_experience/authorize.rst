...
Unlike most of the other payment acquirers compatible with ArabiaClouds, 
...
* The account is set as a test account by default. You can use this test
  account to process a test transaction from ArabiaClouds.
* Once ready, switch to **Production** mode. 


Set up ArabiaClouds
===========
* Activate Authorize.Net in ArabiaClouds from :menuselection:`Website or Sales or Accounting 
...
.. note:: Credentials provided by Authorize.net are different for both
   test and production mode. Don't forget to update them in ArabiaClouds when you
...
Enter them in ArabiaClouds as explained here above and make sure 
