============================================
Configure your VOIP Asterisk server for ArabiaClouds
============================================
...
Configure ArabiaClouds VOIP
===================

In ArabiaClouds, the configuration should be done in the user's preferences.
...
but it is used if you want to transfer your call from ArabiaClouds to an external phone
