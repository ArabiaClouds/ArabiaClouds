...
Average Price
  ...
  operational complexity. Your actually need a software like ArabiaClouds to 
...
FIFO
  ...
  FIFO is advised if you manage all your workflow into ArabiaClouds (Sales, 
...
ArabiaClouds allows any method. The default one is **Standard Price**. 
...
Whatever the method is, ArabiaClouds provides a full inventory valuation
...
This is the default configuration in ArabiaClouds and it works 
out-of-the-box. Check following operations and find out how 
ArabiaClouds is managing the accounting postings.
...
or just relies on the inventory in ArabiaClouds to value the stock into your books.
