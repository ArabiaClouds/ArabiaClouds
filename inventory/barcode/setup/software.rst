=====================================
How to activate the barcodes in ArabiaClouds?
=====================================
...
sure that your products are encoded in ArabiaClouds along with their barcodes.
...
Still, as ArabiaClouds supports any string as a barcode, so you can always
