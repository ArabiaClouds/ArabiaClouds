...
ArabiaClouds, if not you can skip this step.
...
If you select **Validate**, ArabiaClouds will process all quantities to transfer.

If you select **Mark as TODO**, ArabiaClouds will put the transfer in **Waiting
...
.. tip::
	...
	products can't be shipped yet due to an unexpected event), ArabiaClouds will
