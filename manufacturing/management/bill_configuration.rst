...
In ArabiaClouds, each product may have multiple BoMs associated with it, but a
...
in ArabiaClouds). You can do so from :menuselection:`Master Data --> Products`, or
...
In ArabiaClouds, a byproduct is any product produced by a BoM in addition to the
primary product.
