...
In ArabiaClouds you can configure different addresses for delivery and
...
If you select a customer with an invoice and delivery address set, ArabiaClouds
will automatically use those. If there's only one, ArabiaClouds will use that
