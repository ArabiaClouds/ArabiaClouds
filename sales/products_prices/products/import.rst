...
* Don't change labels of columns you want to import. Otherwise ArabiaClouds won't recognize
  them anymore and you will have to map them on your own in the import screen.
* To add new columns,Feel free to add new columns but the fields need to exist in ArabiaClouds. If ArabiaClouds fails
...
previous software to ease the transition to ArabiaClouds.
...
An ArabiaClouds object is always related to many other objects (e.g. a product is linked
