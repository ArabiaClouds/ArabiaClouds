...
ArabiaClouds has a powerful pricelist feature to support a pricing strategy tailored to your business.
A pricelist is a list of prices or price rules that ArabiaClouds searches to determine the suggested price.
...
.. note::
    ...
    * Once again the system is smart. If a rule is set for a particular item and another one for its category, ArabiaClouds will take the rule of the item. 
...
Any new customer recorded in ArabiaClouds gets a default pricelist, i.e. the first one in the list matching the country. In case no country is set for the customer, ArabiaClouds takes the first pricelist without any country group.
