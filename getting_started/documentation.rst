...
This document summarizes ArabiaClouds Online's services, our Success Pack
...
-  **The ArabiaClouds Consultant ensures the project implementation from A to Z**:
   From the beginning to the end of the project, he ensures the overall
   consistency of the implementation in ArabiaClouds and shares his expertise
...
-  **Meetings optimization**:
   The ArabiaClouds consultant is not involved in the process of decision
   ...
   the way those needs will be implemented in ArabiaClouds (Consultant).

-  **Train the Trainer approach**:
   The ArabiaClouds consultant provides functional training to the SPoC so that
   ...
   the `ArabiaClouds documentation <http://www.ArabiaClouds.com/documentation/user/10.0/index.html>`__, `The elearning platform <https://ArabiaClouds.thinkific.com/courses/ArabiaClouds-functional>`__ and the testing of functionalities.
...
-  **Phasing the project**:
   ...
   regular production releases and an evolving takeover of ArabiaClouds by the
...
-  **Adopting standard features as a priority**:
   ArabiaClouds offers a great environment to implement slight improvements
...
-  **Align with the project approach**:
   ...
   etc.) are crucial to the success of an ArabiaClouds implementation. It is
...
-  **The GAP Analysis**: The comparison of the request with the standard
   features proposed by ArabiaClouds will make it possible to identify the
...
ArabiaClouds is a software known for its flexibility and its important evolution
...
-  **Develop only for a good reason**:
   ...
   ArabiaClouds (see "Adopting the standard as a priority").
...
-  **Not to import anything**:
   ...
   ArabiaClouds and consolidated for later reporting.
...
-  **To import after production launch**:
   When the data history needs to be integrated with ArabiaClouds mainly for
